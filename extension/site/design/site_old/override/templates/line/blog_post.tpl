...
<div class="content-view-line">
    <div class="class-blog-post float-break">
				...
				addthis.button("#mysb_{$node.node_id}", {ldelim}{rdelim}, {ldelim} url:"http://www.amandabroadfoot.com{$node.url_alias|ezroot(no)}?article_id={$node.node_id}-{currentdate()}"{rdelim});
				</script>
