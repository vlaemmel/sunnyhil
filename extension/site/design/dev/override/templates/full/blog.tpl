...
<div class="class-blog extrainfo">
    <div class="columns-blog float-break">
        <div class="main-column-position">
            <div class="main-column float-break module">
                <div class="border-box">
                <div class="border-tl"><div class="border-tr"><div class="border-tc"></div></div></div>
                <div class="border-ml"><div class="border-mr"><div class="border-mc float-break">
					
					{*<div class='adbox'>
					<!-- START IndieClix.com CODE -->
					<script type="text/javascript" src="https://indieclix.magicrock.com/track/impression/1O5Qw69L/680/"></script>
					<!-- END IndieClix.com CODE -->
					</div>*}
	
				{if $node.node_id|ne(2)}<h1>{$node.name|wash}</h1>{/if}
...
{/if}
        ...
        <div class="extrainfo-column-position">
            <div class="extrainfo-column module">
                <div class="border-box">
                <div class="border-tl"><div class="border-tr"><div class="border-tc"></div></div></div>
                <div class="border-ml"><div class="border-mr"><div class="border-mc float-break">
