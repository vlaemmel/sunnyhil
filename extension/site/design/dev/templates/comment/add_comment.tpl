...
<div class="ezcom-function-title">
    <h4>
     <a href="#" onclick="opencomments({$contentobject_id});return false;">{'Post comment'|i18n( 'ezcomments/comment/add/form' )}</a>
    </h4>
</div>
...
<div id='thecomform' class="ezcom-add">
	
<form method="post" action={'/comment/add'|ezurl} name="CommentAdd">
<input id='cur_ob_id' type="hidden" name="ContentObjectID" value="{$contentobject_id}" />
